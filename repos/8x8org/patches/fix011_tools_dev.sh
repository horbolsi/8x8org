...
# normalize CRLF just in case + permissions
sed -i 's/\r$//' tools/dev || true

echo "✅ Updated tools/dev (logs + restart + open + safer pids)."
echo "Next:"
echo "  bash tools/dev status"
echo "  bash tools/dev dash:start"
echo "  bash tools/dev dash:tail"
